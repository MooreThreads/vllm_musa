...
#define __CALL_IF(THREAD_M_BLOCKS, THREAD_N_BLOCKS, THREAD_K_BLOCKS,           \
    ...
    musaFuncSetAttribute(Marlin<NUM_THREADS, THREAD_M_BLOCKS, THREAD_N_BLOCKS, \
...
void marlin_cuda(const void *A, const void *B, void *C, void *s, int prob_m,
                 ...
                 int dev = 0, musaStream_t stream = 0, int thread_k = -1,
  ...
  if (sms == -1)
    musaDeviceGetAttribute(&sms, musaDevAttrMultiProcessorCount, dev);
...
torch::Tensor marlin_gemm(torch::Tensor &a, torch::Tensor &b_q_weight,
  ...
  marlin::marlin_cuda(a.data_ptr(), b_q_weight.data_ptr(), c.data_ptr(),
                      ...
                      at::cuda::getCurrentMUSAStream(dev), thread_k, thread_n,
                      sms, marlin::max_par);
