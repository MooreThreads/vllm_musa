...
void marlin_mm_f16i4(const void *A, const void *B, void *C, void *s,
                     ...
                     int group_size, int dev, musaStream_t stream, int thread_k,
...
torch::Tensor gptq_marlin_gemm(torch::Tensor &a, torch::Tensor &b_q_weight,
  ...
  TORCH_CHECK(g_idtrue, "g_idx is not on GPU");
  ...
  gptq_marlin::marlin_mm_f16i4(
      ...
      num_groups, group_size, dev, at::cuda::getCurrentMUSAStream(dev),
